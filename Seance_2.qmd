...
table(rp$stocd, rp$stat_occ, useNA = "always")
...
2.  Créez une variable catégorielle du statut d'immigration `stat_immi` à trois modalités : Immigré étranger/immigré français/français non immigré

3.  Répondez à cette question en produisant les traitements statistiques adaptés : à Lyon, les immigré.es sont-ils plus souvent propriétaires que les non-immigré.es ?

4.  De même : à Lyon, le statut d'occupation du logement est-il dépendant du statut d'immigration ?
