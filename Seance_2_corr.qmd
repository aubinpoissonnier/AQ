...
### `scale_`
Les fonctions `scale_` permettent finalement de transformer les axes et leurs étiquettes. Elles s'écrivent :
- En spécifiant la dimension ciblée (axes x et y, fill, color, alpha etc.)
- La nature de l'échelle (continuous, discrete etc.)
